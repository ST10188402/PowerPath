 ...
 * Use the [ProgressPage.newInstance] factory method to
...
class ProgressPage : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val compp = view.findViewById<Button>(R.id.comparebtn)
        compp.setOnClickListener(){
            val intent = Intent(requireContext(), ComparisonFragment::class.java)
    ...
    companion object {
         ...
         * @return A new instance of fragment ProgressPage.
         */
